...
# Full-screen video playback for Raspberry Pi
...
echo "=========================================="
echo "ADS Display Video Playback Script"
echo "User: $USERNAME"
...
start_xserver() {
    ...
    while [[ $attempt -le $max_attempts ]]; do
        if is_xserver_running; then
            ...
            # Set X properties for full-screen video playback
...
# Optimized MPV startup for full-screen playback
start_mpv() {
    ...
    # MPV configuration for optimal full-screen playback
    # --fs: full-screen mode
...
main() {
    echo "Starting ADS Display Video Playback System..."
...
# Error handling
handle_error() {
    echo "Error occurred in video playback script!"
